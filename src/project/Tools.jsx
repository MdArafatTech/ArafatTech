...
const Tools = () => {
  ...
  const getRealistic3DButtonClasses = (btn) => {
    ...
    let style = isZero ? "col-span-2 rounded-3xl" : "";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
            ...
            <button
              ...
              className="px-6 py-3 text-base cursor-pointer font-semibold bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white rounded-2xl shadow-xl hover:shadow-2xl active:scale-95 transition-all duration-200"
            >
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <button
              onClick={convertUnit}
              className="w-full py-5 px-8 cursor-pointer rounded-3xl text-xl font-bold shadow-2xl hover:shadow-3xl active:scale-95 transition-all duration-200 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 text-white"
            >
              🔄 Convert Units
            </button>
