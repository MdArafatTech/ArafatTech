...
const IdentityForm = () => {
  ...
  if (!currentUser) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900 p-4">
        <LoginModal 
          onClose={() => {
  ...
  useEffect(() => {
    QRCode.toDataURL(JSON.stringify(form))
      .then(setQrDataURL)
      .catch(() => {});
  }, [form]);
  useEffect(() => {
  ...
  const createPDFDoc = () =>
    new jsPDF({
      unit: PERFECT_PDF_CONFIG.page.unit,
      format: PERFECT_PDF_CONFIG.page.format,
    });
  ...
  const drawProfileSection = async (doc, pageWidth, contentY) => {
    ...
    if (qrDataURL)
      doc.addImage(qrDataURL, "PNG", qrX, contentY, qrSize, qrSize);

    const imageData = await getImageData(imageFile);
    if (imageData)
      doc.addImage(imageData, "JPEG", imgX, contentY, imageWidth, imageHeight);
  ...
  const drawAddressTables = (doc, contentY, pageWidth) => {
    ...
    doc.setFont("helvetica", "bold");
    doc.setTextColor(...config.colors.textDark);
    doc.text("PRESENT ADDRESS", margin + tableWidth / 2, y + 15, {
      align: "center",
    });

    doc.setFillColor(...config.colors.permanentHeader);
    doc.rect(
      margin + tableWidth + 15,
      y,
      tableWidth,
      config.sizes.rowHeight + 2,
      "F"
    );
    doc.text(
      "PERMANENT ADDRESS",
      margin + tableWidth + 15 + tableWidth / 2,
      y + 15,
      { align: "center" }
    );
    ...
    fields.forEach((field) => {
      ...
      doc.text(
        field.charAt(0).toUpperCase() + field.slice(1),
        margin + tableWidth + 15 + config.sizes.padding,
        y + 12
      );
  ...
  const drawEducationTable = (doc, contentY, pageWidth) => {
    ...
    const educationData = [
      ...
      [
        ...
        form.university_year || "-",
        form.university_degree || "-",
      ],
    ];
    ...
    educationData.forEach((rowData) => {
      ...
      rowData.forEach((cellValue, colIndex) => {
        ...
        doc.setFont(
          colIndex === 0 ? "helvetica" : "helvetica",
  ...
  const drawFooter = (doc, pageWidth) => {
    ...
    const footerText = doc.splitTextToSize(
      "Powered by Arafat-Tech Ltd - Professional Identity Document",
      pageWidth - 60
    );
  ...
  const inputGroup = (label, name, type = "text", disabled = false) => (
    <div className="space-y-1.5 sm:space-y-2 group">
      <label
        htmlFor={name}
        className={`block text-xs sm:text-sm font-semibold transition-all ${
          isDark
      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          <div className="text-center mb-6 sm:mb-8 lg:mb-12 relative">
            ...
            <h1
              className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black mb-3 sm:mb-4 lg:mb-6 leading-tight drop-shadow-2xl ${
                isDark
            ...
            <div
              className={`mx-auto w-20 sm:w-24 lg:w-32 h-1.5 sm:h-2 lg:h-2 rounded-full shadow-lg ${
                isDark
            ...
            />
            <p
              className={`mt-2 sm:mt-3 lg:mt-4 text-sm sm:text-base lg:text-lg font-medium opacity-90 ${
          ...
          {!preview ? (
            <>
              <section
                className={`${sectionStyle} mb-6 sm:mb-8 lg:mb-10 p-2 md:p-6 lg:p-8 rounded-2xl sm:rounded-3xl relative overflow-hidden`}
              >
                <div className="absolute top-0 left-0 w-full h-1.5 sm:h-2 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-t-2xl" />
                <h2
                  className={`text-xl sm:text-2xl lg:text-2xl font-black mb-6 sm:mb-8 text-center ${
                    isDark
              ...
              <section
                className={`${sectionStyle} mb-6 sm:mb-8 lg:mb-10 p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl relative overflow-hidden`}
              >
                ...
                <div
                  className={`p-4 sm:p-6 rounded-2xl sm:rounded-3xl border-4 transition-all w-full ${
                    isDark
                ...
                >
                  <label className="flex flex-col sm:flex-row sm:items-center justify-center gap-3 sm:gap-4 cursor-pointer group">
                    ...
                    />
                    <span
                      className={`text-base sm:text-xl font-bold transition-all text-center sm:text-left ${
                        isDark
              ...
              <section
                className={`${sectionStyle} mb-8 sm:mb-10 lg:mb-12 p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl relative overflow-hidden`}
              >
                <div className="absolute top-0 left-0 w-full h-1.5 sm:h-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-t-2xl" />
                <h2
                  className={`text-lg sm:text-xl lg:text-2xl font-black mb-4 sm:mb-6 lg:mb-10 text-center ${
                    isDark
                ...
                <div
                  className={`p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl mb-4 sm:mb-6 lg:mb-8 border-2 border-dashed transition-all group ${
                    isDark
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                    <div
                      className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full mt-1 sm:mt-2 flex-shrink-0 self-center sm:self-start ${
                        isDark ? "bg-purple-400" : "bg-purple-600"
                      }`}
                    />
                    <h3
                      className={`font-bold text-sm sm:text-base lg:text-lg flex-1 text-center sm:text-left ${
                  ...
                  >
                    Use{" "}
                    <span className="font-mono bg-purple-500/20 px-1 sm:px-2 py-px sm:py-1 rounded font-semibold text-xs border border-purple-400/50">
                      short forms
                    </span>{" "}
                    for institution names to prevent line breaks in PDF:
                  </p>
                  <div className="mt-2 sm:mt-3 lg:mt-4 grid grid-cols-2 gap-1.5 sm:gap-2 lg:gap-3 pt-2 sm:pt-3 lg:pt-4 border-t border-purple-200/50 dark:border-purple-700/50">
                    {["RUET", "DU", "BUET", "CUET"].map((uni, idx) => (
                      <code
                        key={idx}
                        className={`p-1.5 sm:p-2 rounded-lg text-xs font-mono text-center bg-white/20 dark:bg-purple-900/50 border w-full ${
                          isDark
                            ? "border-purple-500/50 text-purple-200"
                            : "border-purple-300/50 text-purple-800"
                        }`}
                      >
                        {uni}
                      </code>
                ...
                <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                  {[
                    ...
                    <div
                      key={`edu-${id}`}
                      className={`p-3 sm:p-4 lg:p-8 rounded-xl sm:rounded-2xl lg:rounded-3xl border-2 sm:border-4 group hover:shadow-2xl transition-all w-full ${
                        isDark
                    ...
                    >
                      <h3
                        className={`text-base sm:text-lg lg:text-2xl font-black mb-3 sm:mb-4 lg:mb-8 flex items-center justify-center gap-1 sm:gap-2 lg:gap-4 text-transparent bg-clip-text bg-gradient-to-r ${color}`}
                      >
                        {title}
                      </h3>
              ...
              <div
                className={`${sectionStyle} p-6 sm:p-8 lg:p-12 text-center rounded-2xl sm:rounded-3xl mb-6 sm:mb-8 lg:mb-12 relative overflow-hidden`}
              >
                <div className="absolute inset-0 bg-gradient-to-r from-rose-500/20 to-pink-500/20 rounded-2xl sm:rounded-3xl blur-xl" />
                <h3
                  className={`text-lg sm:text-2xl lg:text-2xl font-black mb-4 sm:mb-6 lg:mb-8 relative z-10 ${
                    isDark
            ...
            <div
              className={`${sectionStyle} p-6 sm:p-8 lg:p-12 rounded-2xl sm:rounded-3xl relative overflow-hidden`}
            >
              ...
              <div className="text-center mb-6 sm:mb-8 lg:mb-12 relative z-10">
                <h2
                  className={`text-2xl sm:text-3xl lg:text-4xl font-black mb-3 sm:mb-4 lg:mb-6 ${
                    isDark
                      ? "bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-2xl"
                ...
                <div
                  className={`mx-auto w-24 sm:w-28 lg:w-28 h-1.5 sm:h-2 lg:h-2 rounded-full shadow-lg ${
                    isDark
              ...
              <div
                className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2 sm:gap-3 lg:gap-4 max-h-80 sm:max-h-96 overflow-y-auto p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl mb-6 sm:mb-8 lg:mb-12 bg-gradient-to-br ${
                  isDark
              ...
              >
                {Object.entries(form).map(([key, val], index) => {
                  ...
                  return (
                    ...
                    >
                      <strong
                        className={`block mb-1 sm:mb-2 text-xs sm:text-sm font-black ${
                          isDark
              ...
              {imageFile && (
                <div className="text-center mb-6 sm:mb-8 lg:mb-12 relative z-10">
                  <h3
                    className={`text-lg sm:text-2xl lg:text-2xl font-black mb-4 sm:mb-6 lg:mb-8 ${
                      isDark
                        ? "text-rose-400 drop-shadow-lg"
                        : "text-rose-600 drop-shadow-lg"
                    }`}
