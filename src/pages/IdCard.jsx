...
//   height: 50,
//   marginBottom: 6,
//   alignSelf: "center", // Ensures the logo is centered within its container
// },
// collegeName: {
//   fontSize: 20,
//   fontWeight: "bold",
...
//     label: { fontSize: 9, marginTop: 3, flexWrap: "wrap" },
//     value: { fontSize: 12, marginBottom: 2, fontWeight: "bold", flexWrap: "wrap" },
...
//   <View style={{ alignItems: "center" }}>
//     <Image style={styles.logo} src={headerInfo.logo} />
//     <Text style={styles.collegeName} wrap>{headerInfo.collegeName}</Text>
//     <Text style={styles.department} wrap>{headerInfo.department}</Text>
//     <Text style={styles.session} wrap>Session: {headerInfo.session}</Text>
//   </View>
...
//     <View style={styles.infoBox}>
//       <Text style={styles.label}>Name:</Text>
//       <Text style={styles.value} wrap>{s.name}</Text>

//       <Text style={styles.label}>Roll:</Text>
//       <Text style={styles.value} wrap>{s.roll}</Text>

//       <Text style={styles.label}>Mobile:</Text>
//       <Text style={styles.value} wrap>{s.mobile}</Text>
...
//           <Text style={{ position: "absolute", bottom:1, right:0, fontSize:8, color: "#333" }}>
...
//   const addStudent = () =>
//     setStudents((prev) => [...prev, { name: "", roll: "", email: "", mobile: "", image: null }]);
...
//         className="max-w-4xl mx-auto bg-white rounded-xl shadow-xl p-6 space-y-6"
//       >
//         <h2 className="text-2xl font-bold text-center text-orange-600">ID Card Generator</h2>

//         {/* HEADER FORM */}
//         <div className="border border-gray-400 rounded-xl p-4 bg-orange-50 text-black space-y-3">
//           <h3 className="font-bold text-lg text-orange-700">College Header Settings</h3>
...
//             {headerInfo.logo && headerInfo.logo !== defaultLogo && (
//               <p className="text-sm mt-1 text-green-700 font-semibold">✔ Logo Selected</p>
//             )}
//           </div>
//         </div>
...
//           <motion.button
//             whileHover={{ scale: 1.05 }}
//             onClick={() => setStudents((prev) => [...prev, { name: "", roll: "", email: "", mobile: "", image: null }])}
//             className="bg-blue-500 text-white cursor-pointer px-4 py-2 rounded-lg font-semibold shadow-md hover:bg-blue-600"
//           >
//             + Add More Student
//           </motion.button>
                  ...
                  <View style={styles.studentBox} key={idx}>
                    <View style={styles.cardRow}>
                      <View style={styles.infoBox}>
                        ...
                        <Text style={styles.value}>{s.mobile}</Text>
                        <Text style={styles.label}>Email:</Text>
<View style={{ flexDirection: "row", flexWrap: "wrap",  fontSize: 10,
      textAlign: "left",
      width: "100%",
      fontWeight: "bold", }}>
    ...
    <div className="min-h-screen p-4 bg-gradient-to-br from-yellow-50 to-orange-50">
      ...
      >
        ...
        {students.map((student, index) => (
          ...
          >
            ...
            <input
              ...
              className="w-full border border-black p-2 cursor-pointer rounded-md text-black"
            />
          </motion.div>
        ))}
       ...
       <p className="text-center text-gray-600 mt-4 text-sm">
        Click "Download PDF Now" to generate and download your  ID
        cards instantly.
      </p>
        ...
        {showPreview && (
          ...
          >
            ...
            >
              ...
              >
                <PDFViewer style={{ width: "100%", height: "100%", borderRadius: 10 }}>
                  <MyDocument />
                </PDFViewer>
              </div>
              <div className="mt-4 flex justify-center">
