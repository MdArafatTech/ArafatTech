...
const Services = () => {
  ...
  },
  {
    ...
    desc: "Customizable student ID cards with photo, QR code, academic details, and institutional branding.",
    img: service3,
    link: "/studentidcard",
  },
  {
    title: "Smart ID Card",
    desc: "Advanced smart ID cards with NFC, RFID, biometric integration, and real-time verification.",
    img: service1,
    link: "/smartid",
  },
  {
    title: "Employee ID Card",
    desc: "Professional employee ID cards with access control, photo ID, department info, and security features.",
    img: service2,
    link: "/employee",
  },
  {
    title: "Personal ID Card",
    desc: "Personalized ID cards for individuals, events, members with custom designs and digital features.",
    img: service3,
    link: "/personalidcard",
  },
  {
  ...
  },
  {
    ...
    desc: "Complete student management portal with ID generation, attendance, grades, and academic tools.",
    img: service2,
    link: "/studentportal",
  },
];
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-purple-900/50 dark:to-slate-900 overflow-x-hidden overflow-y-auto">
      ...
      <motion.section
        ...
        className="relative z-10 w-full flex flex-col items-center justify-center max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 mx-auto text-center overflow-hidden"
      >
        <motion.div
          initial={{ scale: 0.8, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-orange-500 to-pink-600 dark:from-orange-500/90 dark:to-pink-600/90 backdrop-blur-sm shadow-2xl shadow-orange-500/25 mb-8 w-full max-w-sm mx-auto"
        >
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20 overflow-x-hidden"
      >
...
>
  ...
  />
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-emerald-500 to-teal-600 dark:from-emerald-600 dark:to-teal-700 text-white font-bold text-base sm:text-lg rounded-2xl shadow-lg hover:shadow-emerald-500/50 transition-all duration-300 backdrop-blur-sm border border-emerald-400/30 hover:scale-105 w-full sm:w-auto flex-shrink-0"
                  >
                    <span>Explore →</span>
                  </motion.button>
                </div>
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.8 }}
        className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20 text-center overflow-hidden"
      >
        <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl rounded-3xl p-8 sm:p-12 lg:p-20 border border-white/40 dark:border-slate-700/50 shadow-2xl w-full max-w-full">
          <motion.div
            ...
            className="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-6 sm:mb-8 bg-gradient-to-r from-orange-500 to-pink-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-orange-500/40 flex-shrink-0"
          >
