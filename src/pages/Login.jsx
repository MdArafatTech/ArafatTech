...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // SUCCESS → Show popup instead of direct redirect
      ...
      if (error.code === "auth/user-not-found" || error.code === "auth/invalid-email") {
        ...
        setErrorMsg("Unable to log in. Please try again later.");
      }
    }
  };
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (isNewUser) {
        ...
        setShowSuccessPopup(true); // Show success popup for Google too
      }
    } catch (error) {
              ...
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="text-right">
                    <Link to="/forgotpass" className="text-blue-600 dark:text-yellow-400 font-medium  text-sm">
                      Forgot Password?
                    </Link>
                  </div>
